...
function csvLoaded() {
	...
	series.series[2] = extractSerieFromCube(data, 'Time', 'Number of Rows');	
	series.series[3] = extractSerieFromCube(data, 'Time', 'Something');		
	series.series[4] = extractSerieFromCube(data, 'Time', 'Some2');			
	series.series[5] = extractSerieFromCube(data, 'Time', 'Some3');				
